  ...
  return (
    ...
    >
      <select
        ...
        className="h-12 rounded-2xl border border-[#cfe5ed] bg-white px-3 text-base text-[#082f49] outline-none transition focus-visible:border-[#7cc8da] focus-visible:ring-3 focus-visible:ring-[#7cc8da]/30"
      >
      ...
      <Button type="submit" className="h-12 bg-[#0f6f8f] text-base text-white transition hover:bg-[#0b5f7b]">
        Aplicar filtros
      </Button>
    </form>
  );
